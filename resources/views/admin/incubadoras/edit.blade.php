        ...
        <div class="statistic-box">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title">Editar Incubadora: {{ $incubadora->nombre }}</h5>
                </div>
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('incubadoras.update', $incubadora->id) }}">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nombre" class="form-control @error('nombre') is-invalid @enderror" 
                                   value="{{ old('nombre', $incubadora->nombre) }}" required>
                            @error('nombre')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="codigo" class="form-control @error('codigo') is-invalid @enderror" 
                                   value="{{ old('codigo', $incubadora->codigo) }}" required>
                            @error('codigo')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="volumen_litros" class="form-control @error('volumen_litros') is-invalid @enderror" 
                                           value="{{ old('volumen_litros', $incubadora->volumen_litros) }}" min="0.1" step="0.1">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="temperatura_optima" class="form-control @error('temperatura_optima') is-invalid @enderror" 
                                           value="{{ old('temperatura_optima', $incubadora->temperatura_optima) }}" step="0.1">
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="ph_optimo" class="form-control @error('ph_optimo') is-invalid @enderror" 
                                           value="{{ old('ph_optimo', $incubadora->ph_optimo) }}" min="0" max="14" step="0.1">
                                    @error('ph_optimo')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" name="oxigeno_disuelto_optimo" class="form-control @error('oxigeno_disuelto_optimo') is-invalid @enderror" 
                                           value="{{ old('oxigeno_disuelto_optimo', $incubadora->oxigeno_disuelto_optimo) }}" step="0.1">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="descripcion" class="form-control @error('descripcion') is-invalid @enderror" rows="3">{{ old('descripcion', $incubadora->descripcion) }}</textarea>
                            @error('descripcion')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="text-end">
                            ...
                            <button type="submit" class="btn btn-primary">Actualizar Incubadora</button>
                        </div>
                    </form>
                </div>
            </div>
