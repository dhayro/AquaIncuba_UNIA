...
<div class="container-xxl flex-grow-1 container-p-y">
    <div class="row mb-4">
        <div class="col-md-8">
            <h4 class="mb-0">Crear Parámetro de Estudio</h4>
        </div>
    </div>
                ...
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('codigo') is-invalid @enderror" 
                            id="codigo" name="codigo" placeholder="Ej: TEMP_MAX" required 
                            value="{{ old('codigo') }}">
                        @error('codigo')
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control @error('nombre') is-invalid @enderror" 
                            id="nombre" name="nombre" placeholder="Ej: Temperatura máxima" required 
                            value="{{ old('nombre') }}">
                        @error('nombre')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control @error('unidad') is-invalid @enderror" 
                            id="unidad" name="unidad" placeholder="Ej: °C, mg/L, %" required 
                            value="{{ old('unidad') }}">
                        @error('unidad')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <select class="form-select @error('tipo_medicion') is-invalid @enderror" 
                            ...
                            <option value="ambas" {{ old('tipo_medicion') == 'ambas' ? 'selected' : '' }}>Ambas</option>
                            <option value="temperatura" {{ old('tipo_medicion') == 'temperatura' ? 'selected' : '' }}>Temperatura</option>
                            <option value="ph" {{ old('tipo_medicion') == 'ph' ? 'selected' : '' }}>pH</option>
                        </select>
                        @error('tipo_medicion')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    ...
                    <div class="col-md-4">
                        ...
                        <input type="number" class="form-control @error('decimales') is-invalid @enderror" 
                            id="decimales" name="decimales" min="0" max="10" value="{{ old('decimales', 2) }}">
                        @error('decimales')
                            <span class="invalid-feedback">{{ $message }}</span>
                        @enderror
                    </div>
