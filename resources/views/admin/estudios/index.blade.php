        ...
        <div class="statistic-box">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h5 class="card-title">Estudios de Calidad de Agua</h5>
                    <a href="{{ route('estudios.create') }}" class="btn btn-primary btn-sm">
                            ...
                            <tbody>
                                @forelse($estudios as $estudio)
                                    <tr>
                                        ...
                                        <td>{{ $estudio->incubadora->nombre }}</td>
                                        <td>{{ $estudio->fecha_inicio->format('d/m/Y') }}</td>
                                        <td>
                                            @if($estudio->fecha_fin && $estudio->fecha_fin->isPast())
                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="{{ route('estudios.destroy', $estudio->id) }}" style="display:inline;">
                                                @csrf
                                                @method('DELETE')
                                ...
                                @empty
                                    <tr>
                                        <td colspan="6" class="text-center">No hay estudios registrados</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
