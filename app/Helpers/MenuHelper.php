...
class MenuHelper
{
    ...
    public static function getRouteFromMenu($menu)
    {
        ...
        $routeMap = [
            ...
            '/menu-permissions' => 'menu-permissions.index',
            '/unidades-medida' => 'unidades-medida.index',
            '/tipos-sensores' => 'tipos-sensores.index',
            '/sensores' => 'sensores.index',
            '/incubadoras' => 'incubadoras.index',
            '/settings/company' => 'empresa.show',
            '/estudios' => 'estudios.index',
            '/estudios-datos' => 'estudios-datos.index',
            '/parametros' => 'parametros.index',
            '/parametros-estudio' => 'parametros-estudio.index',
            '/muestras-estudio' => 'muestras-estudio.index',
            '/datos-crudos' => 'datos-crudos.index',
            '/datos-estudio/crudos' => 'datos-crudos.index',
            '/datos-procesados' => 'datos-procesados.index',
            '/datos-estudio/procesados' => 'datos-procesados.index',
            '/conclusiones' => 'conclusiones.index',
            '/conclusiones-estudio' => 'conclusiones.index',
